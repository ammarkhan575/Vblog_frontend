        ...
        <div className="right_div">
          <div className="board_upper">
            <div className="upperboard_left">
              ...
              <input type="text" value={props.techstack} onChange={handleChange4} placeholder="Your tech stack" />
              <br></br>
              <p className="detailed_info">Available for</p>
              <textarea value={props.avail} onChange={handleChange3} placeholder="I am available for"></textarea>
              <br></br>
              <br></br>
              <br></br>
              <br></br>
              <br></br>
              <Link to="/" bio="this is the bio">
